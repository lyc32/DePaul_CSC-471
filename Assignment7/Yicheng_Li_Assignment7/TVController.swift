//
//  TV_And_Setting_Controller.swift
...
{
    var count:Int = 0;
    var channel_1:Int = 50;
    var channel_2:Int = 75;
    var channel_3:Int = 99;
    var channel_4:Int = 25;
    ...
    @IBAction func power_on(_ sender: UISwitch)
    {
        ...
        channel_1 = appDelegate.channel_1;
        channel_2 = appDelegate.channel_2;
        channel_3 = appDelegate.channel_3;
        channel_4 = appDelegate.channel_4;
        text_list.setTitle(appDelegate.fav_1, forSegmentAt: 0);
        text_list.setTitle(appDelegate.fav_2, forSegmentAt: 1);
        text_list.setTitle(appDelegate.fav_3, forSegmentAt: 2);
        text_list.setTitle(appDelegate.fav_4, forSegmentAt: 3);
    ...
    @IBAction func favorite(_ sender: UISegmentedControl)
    {
        ...
        {
            channel.text = "\(channel_1)";
        }
        if (sender.selectedSegmentIndex == 1)
        {
            channel.text = "\(channel_2)";
        }
        if (sender.selectedSegmentIndex == 2)
        {
            channel.text = "\(channel_3)";
        }
        if (sender.selectedSegmentIndex == 3)
        {
            channel.text = "\(channel_4)";
        }
    }
